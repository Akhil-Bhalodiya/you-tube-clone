...
const Header = () => {
  ...
  const Pagename = Pathname?.split("/")?.flter(Boolean)?.[0];
    ...
    >
      ...
      <div className="flex items-center">
        ...
        <div className="flex h-8 w-8 overflow-hidden rounded-full md:ml-4">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT25URLPQKr_0MzlouZixAOKqjAfvtBIr542w&usqp=CAU"></img>
          </div>
      </div>
    </div>
  );
